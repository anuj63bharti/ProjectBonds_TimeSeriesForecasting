...
<h4>
1. 1.	Python – ML model (auto_arima (for grid search to find p,q,d values), ARIMA(for forecasting values))
2.	SQLite – Database
3.	Flask – Front End for deployment
4.	Python Libraries – numpy, pandas, Statsmodels, re, nsepy, matplotlib
5.	HTML/CSS
</h4>
